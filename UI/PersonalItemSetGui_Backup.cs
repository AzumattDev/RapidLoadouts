...
public class PersonalItemSetGui_Backup : MonoBehaviour
{
    public static PersonalItemSetGui_Backup? m_instance = null!;
    ...
    public static PersonalItemSetGui_Backup? instance => m_instance;
    ...
    public static void Show()
    {
        if (Player.m_localPlayer == null)
            return;
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogWarningIfDebug("TEST1");
        if (IsVisible())
            return;
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogWarningIfDebug("TEST2");
        m_LocalPlayerRef = Player.m_localPlayer;
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogWarningIfDebug("TEST3");
        InventoryGui.instance.m_dropButton.gameObject.SetActive(false);
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogWarningIfDebug("TEST4");

        m_rootPanel.SetActive(true);
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogWarningIfDebug("TEST5");
        PanelActive = true;
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogWarningIfDebug("TEST6");
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogDebugIfDebug("Showing Item Set GUI");
        FillList();
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogWarningIfDebug("TEST7");
    }
    ...
    {
        RapidLoadoutsPlugin.RapidLoadoutsLogger.LogDebugIfDebug("Setting selected recipe " + index.ToString());
